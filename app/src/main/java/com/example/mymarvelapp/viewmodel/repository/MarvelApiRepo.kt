...
import com.example.mymarvelapp.data.network.MarvelApiInterface
...
class MarvelApiRepo(private val api: MarvelApiInterface) {
    ...
    fun query(query: String) {
        ...
        api.getCharacters(query)
            .enqueue(
                object : Callback<CharactersApiResponse> {
